...
describe('LocalTemplateProvider', () => {
  ...
  describe('listIds', () => {
    ...
    it('should throw for a non-existent directory', async () => {
      const provider = new LocalTemplateProvider({ directory: path.join(FIXTURES_DIR, 'non-existent') })
    ...
    it('should throw if the path is a file', async () => {
      ...
      const provider = new LocalTemplateProvider({directory: filePath})
    ...
    it('should throw TemplateError for an empty directory', async () => {
      ...
      const provider = new LocalTemplateProvider({ directory: emptyDirPath })
  ...
  describe('getFiles', () => {
    ...
    it('should throw TemplateError if template file is missing', async () => {
      ...
      const provider = new LocalTemplateProvider({ directory: TEMP_TEST_DIR })
